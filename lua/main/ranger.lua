...
vim.keymap.set("n", "<leader>rr", "<CMD>RnvimrToggle<CR>", { noremap = true })
vim.keymap.set("t", "<leader>rr", "<CMD>RnvimrToggle<CR>", { noremap = true })
--nnoremap <silent> <M-o> :RnvimrToggle<CR>
--tnoremap <silent> <M-o> <C-\><C-n>:RnvimrToggle<CR>

--Resize floating window by all preset layouts
--vim.keymap.set("t", "<leader>rs", "<CMD>RnvimrResize<CR>", { noremap = true })
